...
def dataset_split():
    ...
    :return:
    """
    train_fold_path = "../data/DrugBank/ddi_total_pair_filter_2"
    ...
    for _, dataset_fold in kf.split(train_dataset):
        train_test.append(dataset_fold)

    for i in range(len(train_test)):
        with open("../data/DrugBank/ddi_filter_fold_" + str(i+1), "w") as f:
            for d_num in train_test[i]:
                f.write(trainCpi_list[d_num] + "\n")
            print("fold", i+1)
